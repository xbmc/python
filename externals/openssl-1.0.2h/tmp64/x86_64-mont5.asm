...
DB	9,0,0,0
	DD	mul_handler wrt ..imagebase
	DD	$L$mulx4x_body wrt ..imagebase,$L$mulx4x_epilogue wrt ..imagebase
ALIGN	8
$L$SEH_info_bn_powerx5:
DB	9,0,0,0
	DD	mul_handler wrt ..imagebase
	DD	$L$powerx5_body wrt ..imagebase,$L$powerx5_epilogue wrt ..imagebase
ALIGN	8
