...
L$_bn_mul_mont_begin:
	...
	and	eax,-4096
L$001page_walk:
	mov	edx,DWORD [eax*1+esp]
	sub	eax,4096
db	46
	jnc	NEAR L$001page_walk
	mov	eax,DWORD [esi]
	mov	ebx,DWORD [4+esi]
	mov	ecx,DWORD [8+esi]
